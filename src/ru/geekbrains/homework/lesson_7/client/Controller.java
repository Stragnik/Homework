package ru.geekbrains.homework.lesson_7.client;
...
public class Controller implements Initializable {
    ...
    public void linkCallbacks() {
        Network.setCallOnException(args -> Controller.this.showAlert(args[0].toString()));

        Network.setCallOnCloseConnection(args -> Controller.this.setAuthenticated(false));

        Network.setCallOnAuthenticated(args -> {
            Controller.this.setAuthenticated(true);
